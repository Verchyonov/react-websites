...
export const AboutDrop = (props: any) => {
  ...
  return (
    <div className="flex flex-col xl:flex-row gap-3 xl:gap-12 w-full justify-between items-center p-4 md:p-10 z-50">
      <div className="select-none flex flex-row lg:w-[30%] w-full items-center justify-center gap-1 lg:gap-2 text-center px-2 py-3 lg:px-8 lg:py-7 border-2 rounded-xl text-white border-[#ebebeb]">
        {!props.isLoading ? (
          <CountdownTimer
            days={days}
            hours={hours}
      ...
      <div className="flex flex-col w-full lg:w-[30%] items-center lg:items-end justify-center px-1 py-2 md:px-8 lg:py-4 border-2 rounded-xl border-[#ebebeb] text-white">
        {!props.isLoading ? (
          <>
            <h1 className="lg:text-xl font-bold text-center md:text-right">
